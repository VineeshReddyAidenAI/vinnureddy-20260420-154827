...
export default function CreateAccountWithNric12() {
  ...
  const handleNext = () => {
    navigate('/create-account-with-nric-2-1')
  }
          ...
          <div className="flex flex-col gap-[16px] w-full">
            ...
            <div className="flex flex-col gap-[4px] w-full">
              <div className="flex flex-col gap-[12px] w-full">
                ...
                <div className="flex items-center px-[16px] py-[12px] gap-[8px] w-full h-[56px] bg-white rounded-[8px] border border-black">
                  <span className="text-[16px] leading-[24px] text-[#212121] font-[Noto_Sans]">chriswong@gmail.com</span>
                  <button 
                    onClick={handleGetOTP}
                    className="flex items-center justify-center px-[16px] py-[8px] gap-[10px] w-[87px] h-[32px] bg-white rounded-[8px] border border-[#005eb8] shadow-[0px_1px_4px_0px_rgba(0,0,0,0.05)] cursor-pointer hover:opacity-90 transition-opacity"
                  >
                    <span className="text-[14px] font-medium leading-[21px] text-[#005eb8] font-[Noto_Sans]">Get OTP</span>
                  </button>
                </div>
              </div>
            </div>
