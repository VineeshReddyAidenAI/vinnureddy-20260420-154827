            ...
            <div className="flex flex-col gap-[8px] w-full">
              <div className="flex flex-col gap-[12px] w-full">
                ...
                <input
                  ...
                  className={`flex items-center px-[16px] py-[12px] gap-[8px] w-full h-[48px] bg-white rounded-[8px] border ${error ? 'border-[#dc3545]' : 'border-black'} font-[Noto_Sans] text-[16px] leading-[24px] text-[#212121]`}
                />
              </div>
              {error && (
