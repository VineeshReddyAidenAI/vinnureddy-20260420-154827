...
export default function CreateAccountWithNric22() {
  ...
  const [otpCode, setOtpCode] = useState('123890')

  const handleNext = () => {
    navigate('/create-account-with-nric-2-1-2')
  }
          ...
          <div className="flex flex-col gap-[16px] w-full">
            ...
            <div className="flex flex-col gap-[4px] w-full">
              <div className="flex flex-col gap-[12px] w-full">
                ...
                <div className="flex items-center px-[16px] py-[12px] gap-[8px] w-full h-[48px] bg-white rounded-[8px] border border-black">
                  <span className="text-[16px] leading-[24px] text-[#212121] font-[Noto_Sans]">123890</span>
                </div>
