...
export default function CreateAccountWithNric21() {
  const navigate = useNavigate()
  const [nric, setNric] = useState('S1234567A')
  const [dateOfBirth, setDateOfBirth] = useState('02/05/1982')
  ...
  const handleNext = () => {
    navigate('/create-account-with-nric-2-2')
  }
  ...
  return (
    <div className="min-h-screen w-full flex flex-col md:flex-row overflow-hidden relative">
      {/* Toast */}
      {showToast && (
        <div className="absolute top-[24px] left-1/2 transform -translate-x-1/2 z-10 flex items-center px-[16px] py-[8px] gap-[8px] bg-[#d8ffe2] rounded-[8px] shadow-[0px_1px_4px_0px_rgba(0,0,0,0.05)]">
          ...
          <div className="flex flex-col gap-[16px] w-full">
            <div className="flex flex-col gap-[4px] w-full">
              <div className="flex flex-col gap-[12px] w-full">
                ...
                <div className="flex items-center px-[16px] py-[12px] gap-[8px] w-full h-[48px] bg-white rounded-[8px] border border-black">
                  <span className="text-[16px] leading-[24px] text-[#212121] font-[Noto_Sans]">S1234567A</span>
                </div>
              </div>
            </div>
            <div className="flex flex-col gap-[4px] w-full">
              <div className="flex flex-col gap-[12px] w-full">
                ...
                <div className="flex items-center justify-end px-[16px] py-[12px] gap-[8px] w-full h-[48px] bg-white rounded-[8px] border border-black">
                  <span className="text-[16px] leading-[24px] text-[#212121] font-[Noto_Sans]">02/05/1982</span>
            ...
            <div className="flex flex-col gap-[4px] w-full">
              <div className="flex flex-col gap-[12px] w-full">
                ...
                <div className="flex items-center px-[16px] py-[12px] gap-[8px] w-full h-[48px] bg-white rounded-[8px] border border-black">
                  <span className="text-[16px] leading-[24px] text-[#212121] font-[Noto_Sans]">chriswong@gmail.com</span>
                </div>
                <div className="flex flex-col gap-[12px] w-full">
                  <input
                    type="text"
                    ...
                    className="flex items-center px-[16px] py-[12px] gap-[8px] w-full h-[48px] bg-white rounded-[8px] border border-black font-[Noto_Sans] text-[16px] leading-[24px] text-[#212121] placeholder:text-[#8d8d8d]"
                  />
                  <p className="text-[14px] leading-[21px] text-[#0d6efd] font-[Noto_Sans]">
                    Didn't receive a code? <span className="cursor-pointer" onClick={handleResend}>Resend</span>
                  </p>
                </div>
              </div>
            </div>
